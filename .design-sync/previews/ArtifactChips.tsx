...
const artifacts = [
  ...
  { ref: 'linear.app/frith/TICK-482', kind: 'link', mentions: 3, channelId: 'c2', channelName: 'triage' },
...
export const SingleLink = () => (
  <div style={{ maxWidth: 480 }}>
    <ArtifactChips
      ...
      artifacts={[{ ref: 'github.com/frith/pears#42', kind: 'link', mentions: 1, channelId: 'c4', channelName: 'p2p' }]}
      onOpenChannel={() => {}}
    />
  </div>
);
