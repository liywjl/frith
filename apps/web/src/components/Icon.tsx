// The icon set: inline stroke SVGs (Feather-style), sized in em so they ride
// the surrounding font. Chrome uses these; emoji stays where it's content —
// reactions, statuses, and whatever people put on their profiles.
...
const PATHS = {
  ...
  flame: (
    <path d="M12 22c4-2 6-5 6-8.5 0-3-1.5-5-3-7-.3 2-1 3-2.5 3.5C13 7 12 4.5 12 2c-3 2.5-6 6-6 11.5C6 17 8 20 12 22z" />
  ),
  home: (
    <>
  ...
  signal: (
    <>
      <path d="M5.64 5.64a9 9 0 1 0 12.72 0M8.46 8.46a5 5 0 1 0 7.08 0" />
